# 🚀 Code Agent: A Minimalist ReAct Experiment
...
本项目希望通过使用Agent来构建一个最小可行的coding agent产品，试图回答：**AI agent是怎么展开工作的；以及协作中人类开发者（特别是产品经理视角）的核心价值是什么？**

基于已有的编程基础与对 LLM 的理解，我通过 **Claude Code** 指挥 **MiniMax 2.5** 构建了这个 Coding Agent。它展示了如何通过简单的 ReAct 循环，让模型具备“手”和“眼”，去处理真实的文件系统任务。
